...
- **阶段：** 0.1 局域网闭环准备就绪
- **正在进行：** 尚未开始产品代码；基础环境、Simulator 构建与测试基线已完成
- **下一步：** 实施 0.1：发现 FMO、连接 `/ws`、读取与写入坐标
...
1. 阅读 `docs/spec/product-spec.md` 中 SPEC-001 至 SPEC-004。
2. 阅读 `docs/architecture/modules/device-connectivity.md`。
3. 执行 `docs/plans/0002-milestone-0.1-local-connection.md`。
